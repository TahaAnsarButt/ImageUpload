<header class="page-header" role="banner">
	...
	<div class="page-logo">
		<a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
			...
			<span class="position-absolute text-white opacity-50 small pos-top pos-right mr-2 mt-n2">Image Circulation System</span>
	...
	<div class="hidden-lg-up">
		<a href="#" class="fas fa-align-justify btn press-scale-down" data-action="toggle" data-class="mobile-nav-on">
	...
	<div class="ml-auto d-flex">
		...
		<div style="display:none;">
			...
			<div class="dropdown-menu dropdown-menu-animated w-auto h-auto" style="display:none;">
				<div class="dropdown-header bg-trans-gradient d-flex justify-content-center align-items-center rounded-top" style="display:none;">
					<h4 class="m-0 text-center color-white">
						Quick Shortcut
						<small class="mb-0 opacity-80">User Applications & Addons</small>
					</h4>
				</div>
				<div class="custom-scroll h-100" style="display:none;">
					<ul class="app-list">
						<li>
		...
		<div style="display:none;">
			...
			<div class="dropdown-menu dropdown-menu-animated dropdown-xl" style="display:none;">
				<div class="dropdown-header bg-trans-gradient d-flex justify-content-center align-items-center rounded-top mb-2" style="display:none;">
					<h4 class="m-0 text-center color-white">
						11 New
				...
				<div class="tab-content tab-notification" style="display:none;">
					<div class="tab-pane active p-3 text-center" style="display:none;">
					...
					<div class="tab-pane" id="tab-messages" role="tabpanel" style="display:none;">
						<div class="custom-scroll h-100" style="display:none;">
					...
					<div class="tab-pane" id="tab-feeds" role="tabpanel" style="display:none;">
						<div class="custom-scroll h-100" style="display:none;">
							<ul class="notification">
								<li class="unread">
									<div class="d-flex align-items-center show-child-on-hover" style="display:none;">
										...
										<div class="show-on-hover-parent position-absolute pos-right pos-bottom p-3" style="display:none;">
								...
								<li>
									<div class="d-flex align-items-center show-child-on-hover" style="display:none;">
										<div class="d-flex flex-column flex-1" style="display:none;">
											<span class="name">
								...
								<li>
									<div class="d-flex align-items-center show-child-on-hover" style="display:none;">
										...
										<div class="d-flex flex-column flex-1" style="display:none;">
											...
											<div class="fs-sm d-flex align-items-center mt-2" style="display:none;">
												...
												<div data-hasmore="+3" class="rounded-circle profile-image-md mr-1" style="display:none;">
								...
								<li>
									<div class="d-flex align-items-center show-child-on-hover" style="display:none;">
										<div class="d-flex flex-column flex-1" style="display:none;">
											...
											<div class="fs-sm d-flex align-items-center mt-1" style="display:none;">
								...
								<li>
									<div class="d-flex align-items-center show-child-on-hover" style="display:none;">
										...
										<div class="d-flex flex-column flex-1" style="display:none;">
											<div class="name mb-2" style="display:none;">
												Lisa Lamar<span class="fw-300"> updated project</span>
											</div>
											<div class="row fs-b fw-300" style="display:none;">
												<div class="col text-left" style="display:none;">
													Progress
												</div>
												<div class="col text-right fw-500" style="display:none;">
													45%
												</div>
											</div>
											<div class="progress progress-sm d-flex mt-1" style="display:none;">
					...
					<div class="tab-pane" id="tab-events" role="tabpanel" style="display:none;">
						<div class="d-flex flex-column h-100" style="display:none;">
							<div class="h-auto" style="display:none;">
							...
							<div class="flex-1 custom-scroll" style="display:none;">
								<div class="p-2" style="display:none;">
									<div class="d-flex align-items-center text-left mb-3" style="display:none;">
										<div class="width-5 fw-300 text-primary l-h-n mr-1 align-self-start fs-xxl">
											15
										</div>
										<div class="flex-1" style="display:none;">
											<div class="d-flex flex-column" style="display:none;">
		...
		<div>
			<a href="#" data-toggle="dropdown" title="drlantern@gotbootstrap.com" class="header-icon d-flex align-items-center justify-content-center ml-2">
				<img src="img/demo/avatars/admin.png" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
			...
			<div class="dropdown-menu dropdown-menu-animated dropdown-lg">
				...
				<a href="#" class="dropdown-item" data-toggle="modal">
					<span data-i18n="drpdwn.settings"><?php echo $this->session->userdata('Username'); ?></span>
				</a>

				<div class="dropdown-divider m-0"></div>
				<a href="<?php echo base_url('Login/logout') ?>" class="dropdown-item fw-500 pt-3 pb-3">
